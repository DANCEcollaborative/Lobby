...
minUsersPerRoom = 2
maxUsersPerRoom = 5
maxWaitTimeForSubOptimalAssignment = 30        # seconds
maxWaitTimeUntilGiveUp = 6 * 60                # seconds
maxRoomAgeForNewUsers = 10 * 60                # seconds
...
class User(lobby_db.Model):
    ...
    name = lobby_db.Column(lobby_db.String(80), primary_key=False)
    email = lobby_db.Column(lobby_db.String(80), primary_key=False)
    password = lobby_db.Column(lobby_db.String(100), primary_key=False)
    entity_id = lobby_db.Column(lobby_db.String(80), primary_key=False)
    module_slug = lobby_db.Column(lobby_db.String(80), primary_key=False)
    ope_namespace = namespace
    agent = lobby_db.Column(lobby_db.String(80), primary_key=False)
    socket_id = lobby_db.Column(lobby_db.String(80))
    start_time = lobby_db.Column(lobby_db.DateTime(timezone=False), server_default=func.now())
    room_name = lobby_db.Column(lobby_db.String(80))
